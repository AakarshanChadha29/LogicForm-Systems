      ...
      <Container>
        <ScrollReveal>
          <SectionHeader
            eyebrow="Services"
            title="What We Build"
            description="Explore capabilities across websites, automation, dashboards, applications, IT operations, and cloud delivery."
          />
        </ScrollReveal>
              ...
              >
                ...
                >
                  <GlassCard
                    interactive
                    className={cn(
                      "flex h-full flex-col p-5 transition-transform",
                  ...
                  >
                    ...
                    <span className="mt-5 inline-flex items-center gap-1.5 text-sm font-medium text-accent transition-colors group-hover:text-[var(--accent-hover)]">
                      Explore
