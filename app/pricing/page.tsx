  ...
  return (
    <SiteShell>
      <main id="main-content" className="relative z-10">
        <PageHero
          eyebrow="Pricing"
          title="Premium pricing with clear starting points"
          description="Three main paths cover most engagements. Detailed scope is confirmed after discovery."
        />
            ...
            <div className="grid gap-5 lg:grid-cols-3">
              {homepagePricingPackages.map((pkg) => (
                <article
                  key={pkg.id}
                  className={cn(
                    "glass-card-interactive flex h-full flex-col p-6",
